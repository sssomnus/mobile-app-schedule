      ...
      <nav>
        <div class="container">
          <div id="nav-links">
            <p>English • <a href="http://wikimania.beaubien.qc.ca/?l=fr">Français</a></p>
          </div>
          <div id="nav-links">
            <a href="https://wikimania2017.wikimedia.org/wiki/Venue">Map</a>&nbsp;&nbsp;•&nbsp;&nbsp;
            <a href="https://wikimania2017.wikimedia.org/wiki/Social_Events">Social Events</a>
          </div>
        </div>
      </nav>
  	</header>
    ...
    <script>
      var customConfig = {
        subHeaderText: "August 9-13  •  Montreal, Canada",
        ...
        tabList: [
          { name: 'Friday', displayName: 'Fri', tabDate: new Date(2017,8,11) },
          { name: 'Saturday', displayName: 'Sat', tabDate: new Date(2017,8,12) },
          { name: 'Sunday', displayName: 'Sun', tabDate: new Date(2017,8,13) }
        ]
      }
      // instantiate the app
